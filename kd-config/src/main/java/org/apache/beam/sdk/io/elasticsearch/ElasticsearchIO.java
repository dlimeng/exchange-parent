 ...
 *
 * <p>Optionally, you can provide an {@link Write.FieldValueExtractFn} using {@code
 ...
 *
 * <p>Optionally, you can provide {@link Write.FieldValueExtractFn} using {@code
...
public class ElasticsearchIO {
  ...
  public static class BoundedElasticsearchSource extends BoundedSource<String> {
    ...
    private static JsonNode getStats(
      ...
      try (RestClient restClient = connectionConfiguration.createClient()) {
          ...
          return parseResponse(restClient.performRequest(getRequest("GET",endpoint,params)).getEntity());
  ...
  private static class BoundedElasticsearchReader extends BoundedSource.BoundedReader<String> {
    ...
    public boolean start() throws IOException {
      ...
      Response response = restClient.performRequest(getRequest("GET",endPoint,queryEntity,params));
...
//                "GET", "/_search/scroll", Collections.emptyMap(), scrollEntity);
        Response response = restClient.performRequest(getRequest("GET","/_search/scroll",scrollEntity));
        JsonNode searchResult = parseResponse(response.getEntity());
        updateScrollId(searchResult);
        return readNextBatchAndReturnFirstDocument(searchResult);
      }
    ...
    public void close() throws IOException {
      ...
      try {
        restClient.performRequest(getRequest("DELETE", "/_search/scroll", entity));
  ...
  public abstract static class RetryConfiguration implements Serializable {
    ...
    abstract static class Builder {
      ...
      abstract Builder setRetryPredicate(
  ...
  public abstract static class Write extends PTransform<PCollection<String>, PDone> {
    ...
    static class WriteFn extends DoFn<String, Void> {
      ...
      private void flushBatch() throws IOException, InterruptedException {
        ...
        response = restClient.performRequest(getRequest("POST", endPoint, requestBody));
      ...
      private HttpEntity handleRetry(
        ...
        while (BackOffUtils.next(sleeper, backoff)) {
          ...
          response = restClient.performRequest(getRequest(method, endpoint, requestBody, params));
  ...
  static int getBackendVersion(ConnectionConfiguration connectionConfiguration) {
    try (RestClient restClient = connectionConfiguration.createClient()) {
      Response response = restClient.performRequest(getRequest("GET", ""));
  ...
  static Request getRequest(String method, String endpoint, HttpEntity entity, Map<String, String> params ){
    ...
    if(params !=null && !params.isEmpty()){
      try {
        ...
        throw new IllegalArgumentException("Cannot get Request version", e);
      }
